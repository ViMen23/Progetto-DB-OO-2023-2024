 ...
 ******************************************************************************/
INSERT INTO conf (s_name, l_name, country_id, super_id)
VALUES
(
	'FIFA',
...
(
	...
	get_id('@', 'conf@l_name@Fédération Internationale de Football Association')
...
(
	...
	get_id('@', 'conf@l_name@Asian Football Confederation')	
),
(
	'FAF',
	'Angolan Football Federation',
	get_id('@', 'country@name@Angola'),
	get_id('@', 'conf@l_name@Confederation of African Football')
),
(
	'FSHF',
	'Federata Shqiptare e Futbollit',
	get_id('@', 'country@name@Albania'),
	get_id('@', 'conf@l_name@Union of European Football Associations')
),
(
	'FAF',
...
(
	...
	get_id('@', 'conf@l_name@Confederación Sudamericana de Fútbol')
),
(
	'FFA',
...
(
	...
	get_id('@', 'conf@l_name@Confederation of North and Central America and Caribbean Association Football')
),
(
	'FFA',
...
(
	...
	get_id('@', 'conf@l_name@Oceania Football Confederation')
),
(
	'FFF',
