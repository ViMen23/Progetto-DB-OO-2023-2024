...
//					}
//
//					MyComboBox seasonCombo = yearPanel.getMyComboBox();
//
...
//
//				} else {
//					teamNamePanel.getMyComboBox().setEnabled(null != seasonMap.get(ctrlYear.getText()));
...
//					teamNameMap.clear();
//
//					//TODO NON VA BENE QUESTA FUNZIONE
...
//									seasonMap.get(ctrlYear.getText()),
