...
public class Main
{
	private static void createAndShowGUI()
	{
		...
		JScrollPane scrollPane = new JScrollPane(new ViewTeamPanel("214", "CLUB"), ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
