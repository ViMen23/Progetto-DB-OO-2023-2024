...
public class Main
{
	private static void createAndShowGUI()
	{
		...
		JScrollPane scrollPane = new JScrollPane(new ViewPlayerPanel("3"), ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
